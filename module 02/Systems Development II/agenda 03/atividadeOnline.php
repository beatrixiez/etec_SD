...
<body>
    ...
    <form class="w3-container" action="atividadeOnlineAction.php" method="post" >
      ...
      <select class="w3-input w3-border w3-light-grey" name="cmbPag">
        ...
        <option value="boleto" name="boleto">Boleto</option>
        <option value="deposito" name="deposito" selected>Depósito</option>
      </select>
